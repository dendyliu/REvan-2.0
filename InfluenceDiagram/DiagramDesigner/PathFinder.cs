...
namespace DiagramDesigner
{
    ...
    internal class PathFinder
    {
        ...
        protected static Rect GetRectWithMargin(ConnectorInfo connectorThumb, double margin)
        {
        ...
        protected static Point GetOffsetPoint(ConnectorInfo connector, Rect rect)
        {
