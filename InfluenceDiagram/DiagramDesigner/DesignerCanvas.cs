...
namespace DiagramDesigner
{
    public partial class DesignerCanvas : Canvas
    {
        ...
        public ObservableCollection<DesignerItem> listDesignerItem { get; private set; }
        ...
        protected override void OnPreviewMouseLeftButtonDown(MouseButtonEventArgs e)
        {
            ...
            if(InfluenceDiagram.MainWindow.command != null)
            {
                InfluenceDiagram.MainWindow.command.Execute(position);
            }
            e.Handled = true;
        }
        ...
        protected override void OnDrop(DragEventArgs e)
        {
            ...
            if (dragObject != null && !String.IsNullOrEmpty(dragObject.Xaml))
            {
                ...
                ICommand command = dragObject.Command;
                command.Execute(position);

                //this.AddItem(content, position, dragObject.DesiredSize);
