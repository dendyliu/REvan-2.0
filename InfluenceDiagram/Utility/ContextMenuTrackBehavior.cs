...
{
    public static class ContextMenuTrackBehavior
    {
        public static readonly DependencyProperty TrackOpenLocationProperty = DependencyProperty.RegisterAttached("TrackOpenLocation", typeof(bool), typeof(ContextMenuTrackBehavior), new UIPropertyMetadata(false, OnTrackOpenLocationChanged));
        ...
        public static readonly DependencyProperty OpenLocationProperty = DependencyProperty.RegisterAttached("OpenLocation", typeof(Point), typeof(ContextMenuTrackBehavior), new UIPropertyMetadata(new Point()));
